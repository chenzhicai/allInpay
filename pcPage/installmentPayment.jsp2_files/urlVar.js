...
window.LFQ_installorder_URL = BASE_URL + "/payinstallment/OrderInstallPay/wapinstallorder.do";

//pc端提交金额校验
window.LFQ_pcinstallorder_URL = BASE_URL + "/payinstallment/OrderInstallPay/pcinstallorder.do";
